...
export const Email = ({ className }: mainProps) => {
  return (
    <svg
...
export const Phone = ({ className }: mainProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export const FacebookSolid = ({ className }: mainProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const TwitterSolid = ({ className }: mainProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const LinkedinSolid = ({ className }: mainProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const InstagramSolid = ({ className }: mainProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const YoutubeSolid = ({ className }: mainProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const WhatsApp = ({ className }: mainProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export const Instagram = ({ className }: mainProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export const Snapchat = ({ className }: mainProps) => {
  return (
 <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
...
export const Play = ({ className }: mainProps) => {
  return (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
