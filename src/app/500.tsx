...
export default function Page() {
  return (
    <div className="flex justify-center items-center h-screen flex-col py-5">
      <svg
        id="500_Bill"
      ...
      >
        ...
        <g id="smokes" fill="#D5DADB">
          ...
          <circle
            ...
            className="smoke"
            style={{
              animationDelay: "-0.2s; -moz-transform-origin:464.3px 78.4px;",
            }}
            cx="464.3"
            cy="78.4"
            r="11.3"
          ...
          <circle
            ...
            className="smoke"
            style={{
              animationDelay: "-0.1s; -moz-transform-origin:492.9px 83.8px;",
            }}
            cx="492.9"
            cy="83.8"
            r="8.6"
          ...
          <circle
            id="smoke-base-2"
            style={{ transformOrigin: "480px 70.4px;" }}
            className="smoke"
            cx="480"
            cy="70.4"
            r="8"
          ...
          <circle
            id="smoke-float-2"
            style={{ transformOrigin: "464.9px 53.3px;" }}
            className="emitted-ember"
            fillOpacity=".8"
            cx="464.9"
            cy="53.3"
          ...
          <circle
            id="smoke-float-1"
            style={{ transformOrigin: " 469.4px 62.3px;" }}
            className="emitted-ember emitted-ember-alt"
            fillOpacity=".8"
            cx="469.4"
            cy="62.3"
          ...
          <circle
            id="smoke-float-3"
            style={{ transformOrigin: " 471.1px 47.9px;" }}
            className="emitted-ember"
            fillOpacity=".8"
            cx="471.1"
            cy="47.9"
          ...
          <circle
            id="smoke-float-5"
            style={{ transformOrigin: "470.4px 28.2;" }}
            className="emitted-ember"
            fillOpacity=".3"
            cx="470.4"
            cy="28.2"
          ...
          <circle
            id="smoke-float-4"
            style={{ transformOrigin: " 467.2px 36.3px;" }}
            className="emitted-ember emitted-ember-alt"
            fillOpacity=".6"
            cx="467.2"
            cy="36.3"
        ...
        <g id="fire" clipPath="url(#flame-mask)">
          <path
            id="flame-back"
            style={{ transformOrigin: " 470.729px 93px;" }}
          ...
          <path
            id="flame-front-left"
            style={{ transformOrigin: "462.55px 93px;" }}
            className="flame-front"
            fill="#FB6A4F"
          ...
          <path
            ...
            style={{ transformOrigin: " 479.162px 93px;" }}
          ...
          <path
            id="flame-inner-left"
            style={{ transformOrigin: "461.677px 97px;" }}
          ...
          <path
            ...
            style={{ transformOrigin: " 476.268px 97px;" }}
            className="flame-inner"
            fill="#FFD657"
      ...
      <h3 className="text-3xl text-center mb-5">
        <span className="text-primary font-bold">Sorry !</span> - Internal
        Server Error
      </h3>

      <Link href="/" className="px-10 py-5 text-white bg-primary rounded-md">
        Back To Home
      </Link>
    </div>
  );
